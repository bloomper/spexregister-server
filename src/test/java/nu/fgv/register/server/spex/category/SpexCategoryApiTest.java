...
class SpexCategoryApiTest extends AbstractApiTest {
    ...
    void should_get_export() throws Exception {
        when(jobService.createExportJob(any(), anyList(), any(String.class), any(ImpexType.class), any(Locale.class))).thenReturn(1L);

        mockMvc
                .perform(
                        get("/api/spex/categories?ids=1,2,3&type=excel")
                                .apiVersion("1.0")
                                .header(HttpHeaders.AUTHORIZATION, "Bearer token")
                                .header(HttpHeaders.ACCEPT_LANGUAGE, "en")
                )
                ...
                .andDo(
                        document(
                                ...
                                queryParameters(
                                        ...
                                        parameterWithName("filter").description("The filter to use for the spex categories to export").optional()
                                ),
                                exportResponseFields,
                                security(getRolesFromMethod(SpexCategoryApi.class, "retrieve", List.class, String.class, String.class, Locale.class))
                        )
                );
    }
    ...
    void should_create_import() throws Exception {
        ...
        mockMvc
                .perform(
                        post("/api/spex/categories?type=excel")
                                .apiVersion("1.0")
                                .header(HttpHeaders.AUTHORIZATION, "Bearer token")
                                .header(HttpHeaders.ACCEPT_LANGUAGE, "en")
                ...
                .andDo(
                        document(
                                ...
                                security(getRolesFromMethod(SpexCategoryApi.class, "createAndUpdate", byte[].class, String.class, Locale.class))
                        )
                );
    }
