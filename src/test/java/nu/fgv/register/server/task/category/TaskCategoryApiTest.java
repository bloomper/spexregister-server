...
class TaskCategoryApiTest extends AbstractApiTest {
    ...
    void should_get_export() throws Exception {
        ...
        mockMvc
                .perform(
                        get("/api/tasks/categories?ids=1,2,3&type=excel")
                                .apiVersion("1.0")
                                .header(HttpHeaders.AUTHORIZATION, "Bearer token")
                                .header(HttpHeaders.ACCEPT_LANGUAGE, "en")
                )
                ...
                .andDo(
                        document(
                                ...
                                queryParameters(
                                        ...
                                        parameterWithName("filter").description("The filter to use for the task categories to export").optional()
                                ),
                                exportResponseFields,
                                security(getRolesFromMethod(TaskCategoryApi.class, "retrieve", List.class, String.class, String.class, Locale.class))
                        )
                );
    }
    ...
    void should_create_import() throws Exception {
        ...
        mockMvc
                .perform(
                        post("/api/tasks/categories?type=excel")
                                .apiVersion("1.0")
                                .header(HttpHeaders.AUTHORIZATION, "Bearer token")
                                .header(HttpHeaders.ACCEPT_LANGUAGE, "en")
                ...
                .andDo(
                        document(
                                ...
                                security(getRolesFromMethod(TaskCategoryApi.class, "createAndUpdate", byte[].class, String.class, Locale.class))
                        )
                );
    }
    ...
    void should_get_events() throws Exception {
        final var event1 = EventDto.builder().id(1L).eventType(Event.EventType.CREATE.name()).sourceType(Event.SourceType.TASK_CATEGORY.name()).build();
        final var event2 = EventDto.builder().id(2L).eventType(Event.EventType.UPDATE.name()).sourceType(Event.SourceType.TASK_CATEGORY.name()).build();
        ...
        mockMvc
                .perform(
                        get("/api/tasks/categories/events/{sourceId}?sinceInDays=30", 1)
                                .apiVersion("1.0")
                                .header(HttpHeaders.AUTHORIZATION, "Bearer token")
                                .header(HttpHeaders.ACCEPT_LANGUAGE, "en")
                )
                ...
                .andDo(
                        document(
                                ...
                                secureRequestHeaders,
                                responseHeaders,
                                security(getRolesFromMethod(TaskCategoryApi.class, "retrieveEvents", Long.class, Integer.class))
                        )
                );
    }
