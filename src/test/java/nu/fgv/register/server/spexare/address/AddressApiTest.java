...
class AddressApiTest extends AbstractApiTest {
    ...
    private static final ResponseFieldsSnippet responseFields = auditResponseFields.and(
            ...
            fieldWithPath("country").description("The country ISO code of the address"),
    ...
    void should_get_paged() throws Exception {
        ...
        mockMvc
                .perform(
                        get("/api/spexare/{spexareId}/addresses?page=1&size=2&sort=type,desc&filter=streetAddress:whatever", 1L)
                                .apiVersion("1.0")
                ...
                .andDo(
                        document(
                                ...
                                pageLinks.and(
                                        ...
                                        fieldWithPath("_embedded.addresses[].country").description("The country ISO code of the address"),
    ...
    void should_get() throws Exception {
        ...
        mockMvc
                .perform(
                        get("/api/spexare/{spexareId}/addresses/{id}", 1L, 1L)
                                .apiVersion("1.0")
                                .header(HttpHeaders.AUTHORIZATION, "Bearer token")
                                .header(HttpHeaders.ACCEPT_LANGUAGE, "en")
                )
    ...
    void should_create() throws Exception {
        ...
        mockMvc
                .perform(
                        post("/api/spexare/{spexareId}/addresses/{typeId}", 1L, "HOME")
                                .apiVersion("1.0")
                                .header(HttpHeaders.AUTHORIZATION, "Bearer token")
                                .header(HttpHeaders.ACCEPT_LANGUAGE, "en")
                ...
                .andDo(document(
                                ...
                                requestFields(
                                        ...
                                        fields.withPath("country").description("The country ISO code of the address"),
    ...
    void should_update() throws Exception {
        ...
        mockMvc
                .perform(
                        put("/api/spexare/{spexareId}/addresses/{typeId}/{id}", 1L, "HOME", dto.id())
                                .apiVersion("1.0")
                                .header(HttpHeaders.AUTHORIZATION, "Bearer token")
                                .header(HttpHeaders.ACCEPT_LANGUAGE, "en")
                                .contentType(MediaType.APPLICATION_JSON)
    ...
    void should_partial_update() throws Exception {
        ...
        mockMvc
                .perform(
                        patch("/api/spexare/{spexareId}/addresses/{typeId}/{id}", 1L, "HOME", dto.id())
                                .apiVersion("1.0")
                                .header(HttpHeaders.AUTHORIZATION, "Bearer token")
                                .header(HttpHeaders.ACCEPT_LANGUAGE, "en")
                                .contentType(MediaType.APPLICATION_JSON)
                ...
                .andExpect(jsonPath("id", is(notNullValue())))
                .andDo(document(
                                "spexare-address-update-partial",
                                preprocessRequest(prettyPrint(), modifyHeaders().removeMatching(HttpHeaders.CONTENT_LENGTH).removeMatching(HttpHeaders.HOST)),
                                preprocessResponse(prettyPrint(), modifyHeaders().removeMatching(HttpHeaders.CONTENT_LENGTH)),
                                pathParameters(
                                        parameterWithName("spexareId").description("The id of the spexare"),
                                ...
                                requestFields(
                                        ...
                                        fields.withPath("country").description("The country ISO code of the address").optional(),
    ...
    void should_delete() throws Exception {
        mockMvc
                .perform(
                        delete("/api/spexare/{spexareId}/addresses/{typeId}/{id}", 1L, "HOME", 1L)
                                .apiVersion("1.0")
                                .header(HttpHeaders.AUTHORIZATION, "Bearer token")
                                .header(HttpHeaders.ACCEPT_LANGUAGE, "en")
                )
