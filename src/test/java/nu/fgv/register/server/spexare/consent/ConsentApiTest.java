...
public class ConsentApiTest extends AbstractApiTest {
    ...
    @Test
    public void should_get_paged_consents_by_spexare() throws Exception {
        ...
        mockMvc
                ...
                .andDo(
                        document(
                                "spexare/consents/get-paged-by-spexare",
        ...
        mockMvc
                ...
                .andDo(document(
                                ...
                                pathParameters(
                                        ...
                                        parameterWithName("value").description("The year of the consent")
                                ),
                                responseFields,
                                links,
                                responseHeaders
    ...
    public void should_update_consent() throws Exception {
        ...
        mockMvc
                .perform(
                        put("/api/v1/spexare/{spexareId}/consents/{typeId}/{value}", 1, consent.getId(), Boolean.FALSE)
                )
                .andExpect(status().isAccepted())
                .andExpect(jsonPath("id", is(notNullValue())))
                .andDo(document(
