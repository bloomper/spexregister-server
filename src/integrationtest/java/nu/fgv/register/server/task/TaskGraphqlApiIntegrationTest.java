...
class TaskGraphqlApiIntegrationTest extends AbstractGraphqlIntegrationTest {
    ...
    class RetrievePagedBackwardsTests {
        ...
        void should_return_last_page() {
            final var ids = persistPermittedTasks(25);

            httpGraphQlTester
                    .mutate()
                    .headers(headers -> headers.set(HttpHeaders.AUTHORIZATION, obtainUserAccessToken()))
                    .build()
                    .documentName("task/taskPagedCursor")
                    .variable("last", 10)
                    .execute()
                    .errors()
                    .verify()
                    .path("taskPaged.totalCount").entity(Integer.class).isEqualTo(25)
                    .path("taskPaged.pageInfo.hasNextPage").entity(Boolean.class).isEqualTo(false)
                    .path("taskPaged.pageInfo.hasPreviousPage").entity(Boolean.class).isEqualTo(true)
                    .path("taskPaged.edges[*].node.id").entityList(String.class).isEqualTo(asStrings(ids.subList(15, 25)));
        }

        @Test
        void should_return_everything_when_fewer_than_requested() {
            final var ids = persistPermittedTasks(5);
            ...
            httpGraphQlTester
                    ...
                    .errors()
                    .verify()
                    .path("taskPaged.totalCount").entity(Integer.class).isEqualTo(5)
                    .path("taskPaged.pageInfo.hasNextPage").entity(Boolean.class).isEqualTo(false)
                    .path("taskPaged.pageInfo.hasPreviousPage").entity(Boolean.class).isEqualTo(false)
                    .path("taskPaged.edges[*].node.id").entityList(String.class).isEqualTo(asStrings(ids));
        }
        ...
        void should_return_zero() {
            httpGraphQlTester
                    ...
                    .errors()
                    .verify()
                    .path("taskPaged.totalCount").entity(Integer.class).isEqualTo(0)
                    .path("taskPaged.edges").entityList(TaskDto.class).hasSize(0);
        }
        ...
        void should_page_backwards_from_last_page() {
            ...
            final String startCursor = httpGraphQlTester
                    ...
                    .errors()
                    .verify()
                    .path("taskPaged.pageInfo.startCursor")
                    .entity(String.class)
                    .get();
            ...
            httpGraphQlTester
                    ...
                    .errors()
                    .verify()
                    .path("taskPaged.pageInfo.hasNextPage").entity(Boolean.class).isEqualTo(true)
                    .path("taskPaged.pageInfo.hasPreviousPage").entity(Boolean.class).isEqualTo(true)
                    .path("taskPaged.edges[*].node.id").entityList(String.class).isEqualTo(asStrings(ids.subList(5, 15)));
        }
        ...
        void should_round_trip_forwards_to_last_page() {
            ...
            final String endCursor = httpGraphQlTester
                    ...
                    .errors()
                    .verify()
                    .path("taskPaged.pageInfo.endCursor")
                    .entity(String.class)
                    .get();
        ...
        private List<Long> persistPermittedTasks(final int size) {
            final var category = persistTaskCategory(randomizeTaskCategory());
            grantReadPermissionToRoleUser(toObjectIdentity(TaskCategory.class, category.getId()));
