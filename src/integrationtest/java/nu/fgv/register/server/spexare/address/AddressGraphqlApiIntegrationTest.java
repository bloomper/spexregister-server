    ...
    class RetrievePagedTests {
        ...
        void should_return_NOT_FOUND() {
            httpGraphQlTester
                    ...
                    .build()
                    .documentName("spexare/address/addressPaged")
    ...
    class RetrievePagedWithFilteringTests {
        ...
        void should_return_NOT_FOUND() {
            httpGraphQlTester
                    ...
                    .documentName("spexare/address/addressPaged")
                    .variable("spexareId", 1L)
                    .variable("filter", Address_.STREET_ADDRESS + ":whatever")
                    .execute()
                    .errors()
                    .satisfy((errors) -> assertThat(errors)
                            .anyMatch(error -> error.getExtensions().get("classification").toString().equals(ErrorType.NOT_FOUND.toString()))
        ...
        void should_return_one() {
            ...
            httpGraphQlTester
                    ...
                    .documentName("spexare/address/addressPaged")
                    .variable("spexareId", spexare.getId())
                    .variable("filter", Address_.STREET_ADDRESS + ":" + address.getStreetAddress())
                    .execute()
                    .errors()
                    .verify()
                    .path("addressPaged.edges")
        ...
        void should_return_found() {
            ...
            httpGraphQlTester
                    ...
                    .path("address", result -> result
                            .path("id").entity(Long.class).isEqualTo(address.getId())
                            .path("streetAddress").entity(String.class).isEqualTo(address.getStreetAddress())
                    );
        }
