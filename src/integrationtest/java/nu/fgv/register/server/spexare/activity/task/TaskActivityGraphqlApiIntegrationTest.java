 ...
 * @since 2.0
 */
class TaskActivityGraphqlApiIntegrationTest extends AbstractGraphqlIntegrationTest {
    ...
    @Autowired
    public TaskActivityGraphqlApiIntegrationTest(final JdbcClient jdbcClient,
    ...
    class CreateTests {
        ...
        void should_create() {
            ...
            httpGraphQlTester
                    ...
                    .build()
                    .documentName("spexare/activity/taskActivity/taskActivityCreate")
                    ...
                    .errors()
                    .verify()
                    .path("taskActivityCreate.task", result -> result
        ...
        @Test
        void should_return_NOT_FOUND_when_creating_and_task_not_found() {
            final var spexare = persistSpexare(randomizeSpexare());
            grantReadPermissionToRoleAdmin(toObjectIdentity(Spexare.class, spexare.getId()));
            grantWritePermissionToRoleAdmin(toObjectIdentity(Spexare.class, spexare.getId()));
            final var activity = persistActivity(randomizeActivity(spexare));
    ...
    class UpdateTests {
        ...
        void should_update() {
            ...
            httpGraphQlTester
                    ...
                    .headers(headers -> headers.set(HttpHeaders.AUTHORIZATION, obtainAdminAccessToken()))
                    .build()
                    .documentName("spexare/activity/taskActivity/taskActivityUpdate")
                    .variable("spexareId", spexare.getId())
                    .variable("activityId", activity.getId())
                    .variable("id", taskActivity.getId())
                    .variable("taskId", task2.getId())
                    .execute()
                    .errors()
                    .verify()
                    .path("taskActivityUpdate.task", result -> result
                            .path("name").entity(String.class).isEqualTo(task2.getName())
                    );
        ...
        @Test
        void should_return_NOT_FOUND_when_updating_and_task_not_found() {
            final var spexare = persistSpexare(randomizeSpexare());
            grantReadPermissionToRoleAdmin(toObjectIdentity(Spexare.class, spexare.getId()));
            grantWritePermissionToRoleAdmin(toObjectIdentity(Spexare.class, spexare.getId()));
            final var category = persistTaskCategory(randomizeTaskCategory());
    ...
    class DeleteTests {
        ...
        void should_delete() {
            ...
            httpGraphQlTester
                    ...
                    .headers(headers -> headers.set(HttpHeaders.AUTHORIZATION, obtainAdminAccessToken()))
                    .build()
                    .documentName("spexare/activity/taskActivity/taskActivityDelete")
                    .variable("spexareId", spexare.getId())
                    .variable("activityId", activity.getId())
                    .variable("id", taskActivity.getId())
                    .execute()
