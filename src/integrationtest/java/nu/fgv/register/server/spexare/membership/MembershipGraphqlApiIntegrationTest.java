    ...
    class RetrievePagedTests {
        ...
        void should_return_NOT_FOUND() {
            httpGraphQlTester
                    ...
                    .build()
                    .documentName("spexare/membership/membershipPaged")
    ...
    class RetrievePagedWithFilteringTests {
        ...
        void should_return_NOT_FOUND() {
            httpGraphQlTester
                    ...
                    .documentName("spexare/membership/membershipPaged")
                    .variable("spexareId", 1L)
                    .variable("filter", Membership_.YEAR + ":whatever")
                    .execute()
                    .errors()
                    .satisfy((errors) -> assertThat(errors)
                            .anyMatch(error -> error.getExtensions().get("classification").toString().equals(ErrorType.NOT_FOUND.toString()))
        ...
        void should_return_one() {
            ...
            httpGraphQlTester
                    ...
                    .documentName("spexare/membership/membershipPaged")
                    .variable("spexareId", spexare.getId())
                    .variable("filter", Membership_.YEAR + ":" + membership.getYear())
                    .execute()
                    .errors()
                    .verify()
                    .path("membershipPaged.edges")
        ...
        void should_return_many() {
            ...
            httpGraphQlTester
                    ...
                    .documentName("spexare/membership/membershipPaged")
                    .variable("spexareId", spexare.getId())
                    .variable("filter", Membership_.YEAR + ":1900")
                    .variable("first", size)
                    .execute()
                    .errors()
                    .verify()
    ...
    class RetrieveTests {
        ...
        void should_return_found() {
            ...
            httpGraphQlTester
                    ...
                    .headers(headers -> headers.set(HttpHeaders.AUTHORIZATION, obtainUserAccessToken()))
                    .build()
                    .documentName("spexare/membership/membership")
                    .variable("spexareId", spexare.getId())
                    .variable("id", membership.getId())
                    .execute()
                    .errors()
                    .verify()
                    .path("membership", result -> result
                            .path("id").entity(Long.class).isEqualTo(membership.getId())
                            .path("year").entity(String.class).isEqualTo(membership.getYear())
                    );
        }
