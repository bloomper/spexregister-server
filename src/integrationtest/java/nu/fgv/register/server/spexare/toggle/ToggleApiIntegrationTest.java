...
class ToggleApiIntegrationTest extends AbstractIntegrationTest {
    ...
    @Autowired
    public ToggleApiIntegrationTest(final JdbcClient jdbcClient,
    ...
    void setUp() {
        restTestClient = RestTestClient
                .bindToServer()
                .baseUrl("http://localhost:%s/api/spexare/{spexareId}/toggles".formatted(localPort))
                .apiVersionInserter(ApiVersionInserter.useHeader("X-API-Version"))
                .build();

        JdbcTestUtils.deleteFromTables(jdbcClient, "toggle", "type", "spexare", "toggle_audit", "type_audit", "spexare_audit");
    }
    ...
    class RetrievePagedTests {
        ...
        void should_return_zero() {
            ...
            final List<ToggleDto> result = Objects.requireNonNull(
                            restTestClient
                                    .get()
                                    ...
                                    .exchange()
                                    .expectStatus().isOk()
                                    .expectBody(new ParameterizedTypeReference<@NonNull HalEmbeddedResponse<ToggleDto>>() {
                                    })
                                    .returnResult()
                                    .getResponseBody())
                    .getList("toggles");
    ...
    class RetrieveTests {
        ...
        void should_return_found() {
            ...
            final ToggleDto result = restTestClient
                    .get()
                    .uri("/{id}", spexare.getId(), toggle.getId())
                    .header(HttpHeaders.AUTHORIZATION, obtainUserAccessToken())
                    .header(HttpHeaders.CONTENT_TYPE, MediaType.APPLICATION_JSON_VALUE)
                    .apiVersion("1.0")
                    .exchange()
                    .expectStatus().isOk()
                    .expectBody(ToggleDto.class)
                    .returnResult()
                    .getResponseBody();
    ...
    class UpdateTests {
        ...
        void should_update_and_return_200() {
            ...
            restTestClient
                    .put()
                    .uri("/{typeId}/{id}", spexare.getId(), type.getId(), toggle.getId())
                    .header(HttpHeaders.AUTHORIZATION, obtainAdminAccessToken())
                    .header(HttpHeaders.CONTENT_TYPE, MediaType.APPLICATION_JSON_VALUE)
                    .apiVersion("1.0")
                    .body(dto)
        ...
        void should_return_404_when_updating_and_spexare_not_found() {
            ...
            final ProblemDetail result = restTestClient
                    .put()
                    .uri("/{typeId}/{id}", 1L, type.getId(), toggle.getId())
                    .header(HttpHeaders.AUTHORIZATION, obtainAdminAccessToken())
                    .header(HttpHeaders.CONTENT_TYPE, MediaType.APPLICATION_JSON_VALUE)
                    .apiVersion("1.0")
                    .body(dto)
        ...
        void should_return_404_when_updating_and_type_not_found() {
            ...
            final ProblemDetail result = restTestClient
                    .put()
                    .uri("/{typeId}/{id}", spexare.getId(), "dummy", toggle.getId())
                    .header(HttpHeaders.AUTHORIZATION, obtainAdminAccessToken())
                    .header(HttpHeaders.CONTENT_TYPE, MediaType.APPLICATION_JSON_VALUE)
                    .apiVersion("1.0")
                    .body(dto)
        ...
        void should_return_404_when_updating_and_incorrect_spexare() {
            ...
            final ProblemDetail result = restTestClient
                    .put()
                    .uri("/{typeId}/{id}", spexare1.getId(), type.getId(), toggle.getId())
                    .header(HttpHeaders.AUTHORIZATION, obtainAdminAccessToken())
                    .header(HttpHeaders.CONTENT_TYPE, MediaType.APPLICATION_JSON_VALUE)
                    .apiVersion("1.0")
                    .body(dto)
