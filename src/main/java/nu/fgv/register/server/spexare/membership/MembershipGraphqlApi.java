...
public class MembershipGraphqlApi {
    ...
    @RequiresAdminOrEditorOrUser
    public Window<MembershipDto> retrieveBySpexare(final SpexareDto dto, final ScrollSubrange subrange, @Nullable @Argument final String filter, @Nullable final Sort sort) {
